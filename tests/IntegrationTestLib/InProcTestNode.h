...
public:
  InProcTestNode(const TestNodeConfiguration& cfg, const Fortress::Currency& currency);
  ~InProcTestNode();
...
private:
  ...
  std::unique_ptr<Fortress::core> core;
  std::unique_ptr<Fortress::FortressProtocolHandler> protocol;
  std::unique_ptr<Fortress::NodeServer> p2pNode;
