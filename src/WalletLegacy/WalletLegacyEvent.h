...
public:
  ...
  virtual void notify(Tools::ObserverManager<Fortress::IWalletLegacyObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(Tools::ObserverManager<Fortress::IWalletLegacyObserver>& observer) override
  {
