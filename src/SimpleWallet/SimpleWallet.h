...
namespace Fortress
{
  ...
  /*                                                                      */
  /************************************************************************/
  class simple_wallet : public Fortress::INodeObserver, public Fortress::IWalletLegacyObserver, public Fortress::INodeRpcProxyObserver {
  public:
    simple_wallet(System::Dispatcher& dispatcher, const Fortress::Currency& currency, Logging::LoggerManager& log);
  ...
  private:
    ...
    {
    public:
      refresh_progress_reporter_t(Fortress::simple_wallet& simple_wallet)
    ...
    private:
      Fortress::simple_wallet& m_simple_wallet;
  ...
  private:
    ...
    std::unique_ptr<Fortress::NodeRpcProxy> m_node;
