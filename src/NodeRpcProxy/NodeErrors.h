...
inline std::error_code make_error_code(Fortress::error::NodeErrorCodes e) {
  return std::error_code(static_cast<int>(e), Fortress::error::NodeErrorCategory::INSTANCE);
}
