...
#include "FortressCore/ITimeProvider.h"
#include "FortressCore/ITransactionValidator.h"
#include "FortressCore/ITxPoolObserver.h"
...
namespace Fortress {
  ...
  public:
    OnceInTimeInterval(unsigned interval, Fortress::ITimeProvider& timeProvider)
  ...
  private:
    ...
    unsigned m_interval;
    Fortress::ITimeProvider& m_timeProvider;
  };
  ...
  public:
    tx_memory_pool(
      ...
      Fortress::ITransactionValidator& validator,
      Fortress::ITimeProvider& timeProvider,
      Logging::ILogger& log);
  ...
  private:
    ...
    Fortress::ITransactionValidator& m_validator;
    Fortress::ITimeProvider& m_timeProvider;
