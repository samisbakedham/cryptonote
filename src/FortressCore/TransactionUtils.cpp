...
bool checkInputsKeyimagesDiff(const Fortress::TransactionPrefix& tx) {
...
const TransactionInput& getInputChecked(const Fortress::TransactionPrefix& transaction, size_t index) {
...
const TransactionInput& getInputChecked(const Fortress::TransactionPrefix& transaction, size_t index, TransactionTypes::InputType type) {
...
const TransactionOutput& getOutputChecked(const Fortress::TransactionPrefix& transaction, size_t index) {
...
const TransactionOutput& getOutputChecked(const Fortress::TransactionPrefix& transaction, size_t index, TransactionTypes::OutputType type) {
...
bool findOutputsToAccount(const Fortress::TransactionPrefix& transaction, const AccountPublicAddress& addr,
