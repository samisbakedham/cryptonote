...
namespace Fortress {
  ...
  //-----------------------------------------------------------------------
  bool operator ==(const Fortress::Transaction& a, const Fortress::Transaction& b) {
    return getObjectHash(a) == getObjectHash(b);
  }
  //-----------------------------------------------------------------------
  bool operator ==(const Fortress::Block& a, const Fortress::Block& b) {
    return Fortress::get_block_hash(a) == Fortress::get_block_hash(b);
  }
}
